...
public class VueControleur extends JFrame implements java.util.Observer {
    ...
    private Color couleurSurbrillance = new Color(236, 198, 151);
    private Color couleurClair = new Color(125, 135, 150);
    private Color couleurFonce = new Color(238, 238, 238);
    ...
    private void placerLesComposantsGraphiques() {
        ...
        for (int y = sizeY - 1; y >= 0; y--) {
            for (int x = 0; x < sizeX; x++) {
                ...
                if ((x + y) % 2 == 0) {
                    jlab.setBackground(couleurClair);
                } else {
                    jlab.setBackground(couleurFonce);
                }
    ...
    public void exporterPNG() {
        BufferedImage image = new BufferedImage(getWidth(), getHeight(), BufferedImage.TYPE_INT_ARGB);
        paint(image.getGraphics());
        try {
            File out = new File("partie_finale.png");
